...
class K9LkInstitusiNarasiKriteria4Form extends K9LkInstitusiKriteria4Narasi
{
    ...
    {
        $this->lkInstitusiKriteria4->updateProgressNarasi()->save(false);
    ...
    public function hitungNarasi()
    {
        ...
        $exclude = ['id', 'id_lk_institusi_kriteria4', 'progress', 'created_at', 'updated_at'];
