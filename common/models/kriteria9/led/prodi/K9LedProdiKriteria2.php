 ...
 * @property K9LedProdiNarasiKriteria2 $k9LedProdiNarasiKriteria2s
 */
class K9LedProdiKriteria2 extends \yii\db\ActiveRecord
{
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getK9LedProdiNarasiKriteria2s()
    {
        return $this->hasOne(K9LedProdiNarasiKriteria2::className(), ['id_led_prodi_kriteria2' => 'id']);
    }

    public function updateProgress()
    {
        $narasi = $this->k9LedProdiNarasiKriteria2s->progress;

        $dokumen = K9ProdiProgressHelper::getDokumenLedProgress($this->id_led_prodi,$this->getK9LedProdiKriteria2Details(), 1);
